...
public class TaskListDaoTestSuite {
    ...
    private static final String LIST_NAME = "Task list no 1";

    @Test
    public void testFindByListName() {
        //Given
        TaskList taskList = new TaskList(LIST_NAME, "To do list");
        taskListDao.save(taskList);
        //When
        List<TaskList> result = taskListDao.findByListName(LIST_NAME);
        String listDescription = taskList.getDescription();

        //Then
        Assert.assertEquals(1, result.size());
        Assert.assertEquals("To do list", listDescription);
